...
Scored 5399 / 6000 pairs (failure rate 10.02%). **Accuracy 99.09%**, precision 99.89%, recall 98.29%, false match rate 0.11%, false non-match rate 1.71%, ROC-AUC 0.9975, EER 0.78%. Confusion matrix: {'false_negative': 46, 'false_positive': 3, 'true_negative': 2701, 'true_positive': 2649}. Mean embedding time 15.33 ms (p95 16.58 ms) over 7162 unique images.
